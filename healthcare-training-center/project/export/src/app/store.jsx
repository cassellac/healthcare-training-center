...
const STORE_IMG = {
  cs:         window.__resources.storeCs,
  hipaa:      window.__resources.storeHipaa,
  compliance: window.__resources.storeCompliance,
  records:    window.__resources.storeRecords,
  finance:    window.__resources.storeFinance,
};
  ...
  return (
    <div className="store-wrap">
      ...
      <div className={'iso-stage' + (selected ? ' has-selection' : '')}>
        ...
        {/* hero background */}
        <img src={window.__resources.heroLobby} className="iso-bg-img" alt="Healthcare Training Center lobby" draggable="false" />
